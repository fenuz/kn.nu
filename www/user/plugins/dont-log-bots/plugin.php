...
// Skip if it's a bot
function ozh_dlb_skip_if_bot($shunt) {
		// modified for kort.kennisnet.nl:
		// $shunt variable ensures that we shunt if its a bot, or if 
		// another filter decides the shunt should activate. This prevents a
		// conflict with the Dont Log Admins plugin. 
        return ozh_dlb_is_bot() || $shunt;
